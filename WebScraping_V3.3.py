...
statement = text("""
INSERT INTO BOT_JOB (offre_number, poste, address, dept, ville, date_publication, description, skills, xp, Qualification, secteur_activity, entreprise, url, date1, dateLast)
  VALUES(:offre_number, :poste, :address, :dept, :ville, :date_publication, :description, :skills, :xp, :Qualification, :secteur_activity, :entreprise, :url , CURRENT_DATE(), CURRENT_DATE())
ON DUPLICATE KEY
UPDATE
...
for i in listebis:
    ...
    param = {'offre_number' :offre_number, 'poste' :poste,'address' :address, 'dept' :dept, 'ville' :ville, 'date_publication' :date_publication, 'description' :description, 'skills' :skills,'xp' :xp,'Qualification' :Qualification,'secteur_activity' :secteur_activity,'entreprise' :entreprise, 'url' :url}
    print(param)
