...
for i in listebis:
    ...
    if poste == "":
        ...
        poste = str(soup.find_all("h1", itemprop="title")).replace("</h1>]","")[39:]
#############################
    ...
    if ville == "e-France":
        ville = "Ile-de-France"
    elif ville == "e-Val de Loire":
        ville = "Centre-Val de Loire"
    elif ville == "bourg":
        ville = "Luxembourg"
    elif ville == "e":
        ville ="France"
    elif ville =="nce-Alpes-Côte d'Azur":
        ville = "Provence-Alpes-Côte d'Azur"
    elif ville =="gne-Rhône-Alpes":
